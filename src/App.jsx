...
function App() {
  ...
  const renderMarkets = () => (
    <div className="markets-container">
      <h2 className="markets-header"> Crypto Market Dashboard</h2>
  ...
  const renderAbout = () => (
    <div className="about-container">
      <h2>About Crypto Intelligence Dashboard</h2>
      ...
      <section className="about-section">
        ...
        <p>
          Crypto Intelligence Dashboard is a modern, responsive web application that provides real-time 
      ...
      <section className="about-section">
        ...
        <div className="feature-list">
          ...
          <div className="feature-item">
            ...
            <span> Market insights with real-time updates</span>
          </div>
        </div>
      </section>
      ...
      <section className="about-section">
        ...
        <p>
          This application was developed by Kulbhushan Sharma, a passionate software architect focused on creating 
        ...
        <div className="social-links">
          <a href="https://github.com/Kwebdev1234" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="GitHub">
            <svg viewBox="0 0 24 24">
          ...
          <a href="https://www.linkedin.com/in/kulbhushan-sharma-29546b140/" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="LinkedIn">
            <svg viewBox="0 0 24 24">
              <path d="M19,3A2,2 0 0,1 21,5V19A2,2 0 0,1 19,21H5A2,2 0 0,1 3,19V5A2,2 0 0,1 5,3H19M18.5,18.5V13.2A3.26,3.26 0 0,0 15.24,9.94C14.39,9.94 13.4,10.46 12.92,11.24V10.13H10.13V18.5H12.92V13.57C12.92,12.8 13.54,12.17 14.31,12.17A1.4,1.4 0 0,1 15.71,13.57V18.5H18.5M6.88,8.56A1.68,1.68 0 0,0 8.56,6.88C8.56,5.95 7.81,5.19 6.88,5.19A1.69,1.69 0 0,0 5.19,6.88C5.19,7.81 5.95,8.56 6.88,8.56M8.27,18.5V10.13H5.5V18.5H8.27Z" />
            </svg>
          </a>
          <a href="mailto:kwebdev72@gmail.com" className="social-link" aria-label="Email">
            <svg viewBox="0 0 24 24">
              <path d="M20,8L12,13L4,8V6L12,11L20,6M20,4H4C2.89,4 2,4.89 2,6V18A2,2 0 0,0 4,20H20A2,2 0 0,0 22,18V6C22,4.89 21.1,4 20,4Z" />
            </svg>
          </a>
        ...
        <div className="about-footer">
          <p>Want to check out more of my work? Visit my <a href="https://kwebdev.netlify.app/" target="_blank" rel="noopener noreferrer" style={{color: 'darkturquoise'}}>portfolio website</a>!</p>
        </div>
      </section>
    </div>
  );
    ...
    <div className={`app ${theme}`}>
      <header className="header">
        <div className="logo-container">
          ...
          <h1 style={{ color: 'white', cursor: 'pointer' }} onClick={() => setActivePage('home')}>Crypto Intelligence Dashboard</h1>
        </div>
      ...
      <footer className="footer">
        <p>© {new Date().getFullYear()} Crypto Intelligence Dashboard. Data provided by CoinGecko API.</p>
      </footer>
    </div>
  );
}
